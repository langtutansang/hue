                            ...
                            <table id="table" width="100%" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="date">Câu hỏi</th>
                                        <th data-field="test_id">Đáp án</th>
                                ...
                                <td>{{ $key+1 }}</td>
                                <td>ss</td>
                                <td>{{$row->resultTest->test->title }}</td>
                                <td>{{$row->answer }}</td>
                                <td>{{$row->resultTest->score }}</td>
                                @endforeach
                                </tbody>
                            </table>
                        </div>
...
@section('css')
    @include('admin.resulttest.css')
@endsection

@section('script')
    @include('admin.resulttest.script')
@endsection